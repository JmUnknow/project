...
jobs_db = {
    "IT & Разработка 💻": [
        ...
        {"name": "Backend-разработчик ⚙️", "desc": "Отвечает за серверную логику и базы данных 🧠."},
        ...
        {"name": "Разработчик игр 🎮", "desc": "Создает миры и механику видеоигр 🌍."}
    ],
    "Дизайн 🎨": [
        ...
        {"name": "Иллюстратор ✏️", "desc": "Создает уникальные рисунки для книг и брендов 📚."},
    ...
    "Финансы & Аналитика 💰": [
        ...
        {"name": "Риск-менеджер ⚠️", "desc": "Просчитывает возможные потери в бизнесе 📊."},
    ...
    "Образование 🎓": [
        ...
        {"name": "Корпоративный тренер 🗣️", "desc": "Обучает сотрудников внутри больших компаний 🏢."},
        {"name": "Тьютор 🤍", "desc": "Персональный наставник в обучении 🙌."},
        {"name": "Разработчик онлайн-курсов ⚙️", "desc": "Создает техническую начинку для обучения 🧩."}
    ],
    "Медицина & BioTech 🧬": [
        ...
        {"name": "Психолог-коуч 🧠", "desc": "Помогает достигать целей и внутреннего баланса 🌱."},
        {"name": "Специалист по долголетию ⏳", "desc": "Разрабатывает программы продления жизни ✨."}
    ],
    "Техника & Роботы 🤖": [
        {"name": "Инженер БПЛА 🚁", "desc": "Проекпирует и собирает беспилотники ⚙️."},
        ...
        {"name": "Оператор 3D-печати 🖨️", "desc": "Занимается аддитивным производством деталей 🧱."},
        {"name": "Специалист по кибербезопасности 🔐", "desc": "Защищает системы от взломов 🛡️."}
    ],
    "Медиа & Контент 🎬": [
        {"name": "Продюсер подкастов 🎙️", "desc": "Организует запись и продвижение аудио-шоу 🎧."},
        ...
        {"name": "Звукорежиссер 🎚️", "desc": "Работает над чистотой и качеством звука 🎶."},
        {"name": "Редактор спецпроектов 🧩", "desc": "Создает крупные медиа-истории 📰."}
    ],
    "Управление 🧭": [
        {"name": "Product Manager 📦", "desc": "Отвечает за успех и развитие продукта 🚀."},
        {"name": "HR-директор 🤝", "desc": "Управляет развитием команды и культуры 👥."},
        {"name": "Team Lead 🧑‍💻", "desc": "Руководит командой специалистов 💪."},
        {"name": "Операционный директор 🏗️", "desc": "Налаживает внутренние процессы компании ⚙️."},
        {"name": "Менеджер по инновациям 💡", "desc": "Внедряет новые технологии в бизнес 🚀."}
    ],
    "Сервис & Туризм ✈️": [
        {"name": "Travel-дизайнер 🌍", "desc": "Составляет уникальные авторские маршруты 🗺️."},
        {"name": "Менеджер эко-отеля 🌱", "desc": "Управляет отдыхом в стиле eco-friendly ♻️."},
        {"name": "Консьерж-сервис 🤵", "desc": "Решает любые запросы VIP-клиентов 👌."},
        {"name": "Гид по необычным местам 🧭", "desc": "Проводит экскурсии вне туристических маршрутов 👣."},
...
def start(message):
    ...
    btn2 = types.KeyboardButton("О проекте ℹ️")
    markup.add(btn1, btn2)
    bot.send_message(
        message.chat.id,
        "Привет! 👋 Я помогу разобраться в профессиях и направлениях.\nЖми кнопку и погнали 🚀",
        reply_markup=markup
    )

@bot.message_handler(func=lambda m: m.text == "О проекте ℹ️")
def about(message):
    text = (
        "Это не скучный бот, а твой карьерный навигатор 🧭\n\n"
        "— 50 актуальных профессий\n"
        "— 10 направлений\n"
        "— коротко, по делу, без воды 💬\n\n"
        "Просто выбирай и смотри, что тебе реально может зайти 😉"
    )
...
def categories(message):
    bot.send_message(message.chat.id, "Выбери сферу, которая тебе ближе 👇", reply_markup=get_categories_markup())
...
def show_jobs(call):
    ...
    bot.edit_message_text(
        ...
        text=f"Профессии в сфере {category} 👇",
        reply_markup=markup
    )
...
def back_btn(call):
    bot.edit_message_text(
        chat_id=call.message.chat.id,
        message_id=call.message.message_id,
        text="Выбери сферу, которая тебе ближе 👇",
